...
//SFF_BEGIN
	...
	bool ImwWindowManager::Init()
	{
...

		{
			...
			auto font = io.Fonts->AddFontFromFileTTF("External/Externals/imgui/extra_fonts/MaterialIcons-Regular.ttf", 18.0f, &config, icon_ranges);
			//font->DisplayOffset = ImVec2(0, 8);
		}
